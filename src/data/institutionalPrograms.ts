...
export const whoWeServe: WhoWeServeCard[] = [
  {
    ...
    description: "National and subnational health ministries seeking workforce capacity building.",
    icon: "Landmark",
    filterCategories: ["public-health", "executive", "wash"],
  },
  {
    title: "Hospitals & Health Systems",
    description: "Clinical institutions upgrading staff skills and operational readiness.",
    icon: "Hospital",
    filterCategories: ["clinical", "digital-health", "corporate"],
  },
  {
    title: "International NGOs",
    description: "Development organizations delivering health programs in low-resource settings.",
    icon: "Globe",
    filterCategories: ["public-health", "wash", "executive"],
  },
  {
    title: "UN & Multilateral Agencies",
    description: "Agencies coordinating large-scale health and humanitarian responses.",
    icon: "Network",
    filterCategories: ["public-health", "executive", "wash"],
  },
  {
    title: "Private Corporations",
    description: "Employers investing in occupational health and workplace safety programs.",
    icon: "Building2",
    filterCategories: ["corporate", "clinical", "digital-health"],
  },
  {
    title: "African Union & Regional Bodies",
    description: "Continental and regional institutions shaping health policy and governance.",
    icon: "MapPin",
